...
TEST(OpenSpaceToolkit_IO_IP_TCP_HTTP_Response, StringFromStatusCode)
{
...

    {
        ...
        EXPECT_EQ(
            ...
            Response::StringFromStatusCode(Response::StatusCode::NonAuthoritativeInformation)
        );
        ...
        EXPECT_EQ(
            ...
            Response::StringFromStatusCode(Response::StatusCode::ProxyAuthenticationRequired)
        );
        ...
        EXPECT_EQ(
            ...
            Response::StringFromStatusCode(Response::StatusCode::RequestHeaderFieldsTooLarge)
        );
        EXPECT_EQ(
            "UnavailableForLegalReasons",
            Response::StringFromStatusCode(Response::StatusCode::UnavailableForLegalReasons)
        );
        ...
        EXPECT_EQ(
            "HTTPVersionNotSupported", Response::StringFromStatusCode(Response::StatusCode::HTTPVersionNotSupported)
        );
        ...
        EXPECT_EQ(
            ...
            Response::StringFromStatusCode(Response::StatusCode::NetworkAuthenticationRequire)
        );
    }
}
